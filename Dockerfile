FROM crystallang/crystal:0.35.0-alpine-build AS build-env
...
RUN git clone https://github.com/luckyframework/lucky_cli && cd lucky_cli && git checkout v0.22.0 && shards install && crystal build src/lucky.cr -o /bin/lucky && rm -Rf /app/lucky_cli
