class Domains::Show < BrowserAction
  ...
  route do
    ...
    html ShowPage, domain: domain, total_unique: unique_query(domain), total_sum: total_query(domain), period: period, period_string: period_string, events: EventQuery.new.domain_id(domain_id), domains: domains
  end
