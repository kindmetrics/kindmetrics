class PageSpeedLoaderComponent < BaseComponent
  ...
  def render
    ...
    params["data_controller"] = "pagespeed"
    params["data_pagespeed_from"] = from.not_nil! if !from.nil?
    params["data_pagespeed_to"] = to.not_nil! if !to.nil?
    params["data_pagespeed_url"] = "/domains/#{@domain.id}/data/pagespeeds"
    params["height"] = "300"
    params["width"] = "100%"
    params["style"] = "max-height:300px;"
    params["id"] = "pagespeed"

    custom_params = set_params("data_pagespeed_")
