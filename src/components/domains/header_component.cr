        ...
        div class: "flex justify-between items-center" do
          if @share_page
            ...
            div class: "flex items-center" do
              m DomainDropdownComponent.new(domain: @domain, domains: domains)
          ...
          div do
            if show_period?
              m PeriodDropdownComponent.new(period_string, current_url)
            end
          end
        end

        div class: "clear-both w-full pt-2 mt-3" do
          m TabMenu.new(links: links, active: @active, domain: @domain) if @total_sum > 0
        end
      end
    end
  end
