class Domains::Paths::ShowPage < Share::BasePage
  ...
  def render_header
    m HeaderComponent, domain: @domain, current_url: context.request.path, domains: domains, total_sum: 1_i64, share_page: @share_page, period_string: period_string, period: @period, active: "Dashboard"
  end
  ...
  def render_total
    m TotalRowComponent, @unique, @total, @bounce, @unique_previous, @total_previous, @bounce_previous
  end
