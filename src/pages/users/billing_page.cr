class Users::BillingPage < SettingsLayout
  ...
  def render_subscription_window
    div class: "mt-3 w-full grid grid-cols-1 md:grid-cols-3 gap-6" do
      div class: "bg-white border border-kind-gray rounded text-xl text-gray-800 p-4" do
        if subscription.nil?
    ...
    div class: "my-3 border border-gray-200 rounded bg-white p-4" do
      h2 "Events last 30 days", class: "text-xl"
  ...
  def update_payment_window
    ...
    div class: "my-3 border border-gray-200 rounded bg-white p-4", data_controller: "cancel", data_cancel_paddle: KindEnv.env("PADDLE_VENDOR") || "", data_cancel_url: subscription.not_nil!.update_url, data_cancel_success: Users::Plans::Card.url do
  ...
  def cancel_subscription_window
    ...
    div class: "my-3 border border-gray-200 rounded bg-white p-4", data_controller: "cancel", data_cancel_paddle: KindEnv.env("PADDLE_VENDOR") || "", data_cancel_url: subscription.not_nil!.cancel_url, data_cancel_success: Users::Plans::Cancelled.url do
